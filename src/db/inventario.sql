...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-08-2023 a las 10:24:40
...
(1, 'Beverages', 'Soft drinks, coffees, teas, beers, and ales', 'img/Beverages.jpg'),
(2, 'Condiments', 'Sweet and savory sauces, relishes, spreads, and seasonings', 'img/Condiments.jpg'),
(3, 'Confections', 'Desserts, candies, and sweet breads', 'img/Confections.jpg'),
(4, 'Dairy Productos', 'Cheeses', 'img/DairyProductos.jpg'),
(5, 'Grains/Cereals', 'Breads, crackers, pasta, and cereal', 'img/cereals.jpg'),
(6, 'Meat/Poultry', 'Prepared meats', 'img/Meat.jpg'),
(7, 'Produce and som', 'Dried fruit and bean curd abd vegatables', 'img/produce.jpg'),
(8, 'Seafood', 'Seaweed and fish', 'img/Seafood.jpg'),
(9, 'Alcoholic Bever', 'Beer, wine, distilled spirits, fortified wines, cocktails', 'img/alcoholic.jpg'),
(10, 'Animal Food', 'Food, pet food, snacks, training treats', 'img/Animal.jpg'),
(11, 'Lorem Insuppppp', 'Ropa', 'img/Animal.jpg'),
(12, 'Lorem Insuppppp', 'Prueba7', 'Cloud-Computing.jpg'),
(13, 'Lorem Insuppppp', 'Kevin444', 'img/Animal.jpg'),
(14, 'Electrodomestic', 'Electrodomesticos de todas las marcas', 'img/electro.jpg'),
(15, 'Vegetales', 'vegetales y zanahorias', 'img/vegetales.jpg'),
(16, 'Electrodomestic', 'Electrodomesticosxxxxx', 'img/electrodomestico.jpg');
...
('evi', 'kevin', 'Kevin', 'ing Sistemas y sofware', NULL, NULL, NULL, NULL, 'Kevin', NULL, NULL),
...
--
-- Estructura de tabla para la tabla `clientesdemo`
--
...
--
-- Estructura de tabla para la tabla `clientesdemografia`
--
...
(10, 'Mejia', 'Kevin', 'ing Sistemas y sofware', NULL, NULL, NULL, NULL, 'Bucaramanga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://www.nationalgeographic.com.es/medio/2021/10/02/ghost_5965d71c_800x600.jpg'),
(11, 'Mejia', 'Kevin', 'ing Sistemas y sofware', NULL, NULL, NULL, NULL, 'Bucaramanga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://www.nationalgeographic.com.es/medio/2021/10/02/ghost_5965d71c_800x600.jpg');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `empleadoubicaciones`
--
...
--
-- Volcado de datos para la tabla `empleadoubicaciones`
--
...
(78, 'la pata', NULL, 1, 'evelyn', 20000, 0, 0, 0, 0),
(79, 'jjj', NULL, 1, 'jjjj', 2222, 0, 0, 0, 0),
(80, 'Kevin Mejia', NULL, 2, 'Muchaaaaa', 70100000, 0, 0, 0, 0),
(81, 'Kevin', NULL, 9, 'evelyn', 222, 0, 0, 0, 0),
(82, 'Kevin', NULL, 8, 'evelyn', 222, 0, 0, 0, 0);
...
(30, 'Kevin', 'Kevin', NULL, 'Kevin', 'Bucaramanga', NULL, NULL, 'Kevin', NULL, NULL, NULL),
(31, 'Kevin', 'Kevin', NULL, 'Kevin', 'Bucaramanga', NULL, NULL, 'Kevin', NULL, NULL, NULL);
...
ALTER TABLE `categorias`
  ...
  ADD KEY `Categorias_CategoriaNombre` (`CategoriaNombre`);
...
ALTER TABLE `clientes`
  ...
  ADD KEY `Clientes_Ciudad` (`Ciudad`),
  ADD KEY `Clientes_Compania` (`Compania`),
  ADD KEY `Clientes_CodigoPostal` (`CodigoPostal`),
  ADD KEY `Clientes_Regiones` (`Regiones`);

--
-- Indices de la tabla `clientesdemo`
--
ALTER TABLE `clientesdemo`
  ADD PRIMARY KEY (`ClienteID`,`TipoClienteID`),
  ADD KEY `FK_ClientesDemo` (`TipoClienteID`),
  ADD KEY `FK_ClientesDemo_Clientes` (`TipoClienteID`);

--
-- Indices de la tabla `clientesdemografia`
--
ALTER TABLE `clientesdemografia`
...
ALTER TABLE `empleados`
  ...
  ADD KEY `Empleados_Apellido` (`Apellido`),
  ADD KEY `Empleados_CodigoPostal` (`CodigoPostal`),
  ADD KEY `FK_Empleados_Empleados` (`Jefe`);

--
-- Indices de la tabla `empleadoubicaciones`
--
ALTER TABLE `empleadoubicaciones`
  ADD PRIMARY KEY (`EmpleadoID`,`UbicacionID`),
  ADD KEY `FK_EmpleadoUbicaciones_Ubicaciones` (`UbicacionID`);

--
-- Indices de la tabla `facturadetalle`
--
ALTER TABLE `facturadetalle`
  ADD PRIMARY KEY (`FacturaID`,`ProductoID`),
  ADD KEY `FacturaDetalle_FacturaID` (`FacturaID`),
  ADD KEY `FacturaDetalle_FacturaDetalle` (`FacturaID`),
  ADD KEY `FacturaDetalle_ProductoID` (`ProductoID`),
  ADD KEY `FacturaDetalle_ProductosFacturaDetalle` (`ProductoID`);
...
ALTER TABLE `facturas`
  ...
  ADD KEY `Facturas_ClienteID` (`ClienteID`),
  ADD KEY `Facturas_ClientesFacturas` (`ClienteID`),
  ADD KEY `Facturas_EmpleadoID` (`EmpleadoID`),
  ADD KEY `Facturas_EmpleadosFacturas` (`EmpleadoID`),
  ADD KEY `Facturas_FechaFactura` (`FechaFactura`),
  ADD KEY `Facturas_FechaEnvio` (`FechaEnvio`),
  ADD KEY `Facturas_CorreosFacturas` (`EnvioVia`),
  ADD KEY `Facturas_CodigoPostalEnvio` (`CodigoPostalEnvio`),
  ADD KEY `FK_Facturas_Clientes` (`ClienteID`);
...
ALTER TABLE `productos`
  ...
  ADD KEY `Productos_CategoriasProductos` (`CategoriaID`),
  ADD KEY `Productos_CategoriaID` (`CategoriaID`),
  ADD KEY `Productos_ProductoNombre` (`ProductoNombre`),
  ADD KEY `Productos_ProveedorID` (`ProveedorID`),
  ADD KEY `Productos_ProveedoresProductos` (`ProveedorID`);
...
ALTER TABLE `proveedores`
  ...
  ADD KEY `Proveedores_Compania` (`Compania`),
  ADD KEY `Proveedores_PostalCode` (`CodigoPostal`);

--
-- Indices de la tabla `regiones`
--
ALTER TABLE `regiones`
  ADD PRIMARY KEY (`RegionesID`);
...
ALTER TABLE `ubicaciones`
  ...
  ADD KEY `FK_Ubicaciones_Regiones` (`RegionesID`);
...
--
ALTER TABLE `correos`
  MODIFY `CorreoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `facturas`
  MODIFY `FacturaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11078;

--
-- AUTO_INCREMENT de la tabla `productos`
--
ALTER TABLE `productos`
  MODIFY `ProductoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT de la tabla `proveedores`
--
ALTER TABLE `proveedores`
  MODIFY `ProveedorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
-- Filtros para la tabla `clientesdemo`
--
ALTER TABLE `clientesdemo`
  ADD CONSTRAINT `FK_ClientesDemo` FOREIGN KEY (`TipoClienteID`) REFERENCES `clientesdemografia` (`TipoClienteID`),
  ADD CONSTRAINT `FK_ClientesDemo_Clientes` FOREIGN KEY (`ClienteID`) REFERENCES `clientes` (`ClienteID`);

--
-- Filtros para la tabla `empleados`
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `FK_Empleados_Empleados` FOREIGN KEY (`Jefe`) REFERENCES `empleados` (`EmpleadoID`);

--
-- Filtros para la tabla `empleadoubicaciones`
--
ALTER TABLE `empleadoubicaciones`
  ADD CONSTRAINT `FK_EmpleadoUbicaciones_Empleados` FOREIGN KEY (`EmpleadoID`) REFERENCES `empleados` (`EmpleadoID`),
  ADD CONSTRAINT `FK_EmpleadoUbicaciones_Ubicaciones` FOREIGN KEY (`UbicacionID`) REFERENCES `ubicaciones` (`UbicacionID`);

--
-- Filtros para la tabla `facturadetalle`
--
ALTER TABLE `facturadetalle`
  ADD CONSTRAINT `FK_FacturaDetalle_Facturas` FOREIGN KEY (`FacturaID`) REFERENCES `facturas` (`FacturaID`),
  ADD CONSTRAINT `FK_FacturaDetalle_Productos` FOREIGN KEY (`ProductoID`) REFERENCES `productos` (`ProductoID`);
...
ALTER TABLE `facturas`
  ...
  ADD CONSTRAINT `FK_Facturas_Correos` FOREIGN KEY (`EnvioVia`) REFERENCES `correos` (`CorreoID`),
  ADD CONSTRAINT `FK_Facturas_Empleados` FOREIGN KEY (`EmpleadoID`) REFERENCES `empleados` (`EmpleadoID`);
...
--
ALTER TABLE `ubicaciones`
  ADD CONSTRAINT `FK_Ubicaciones_Regiones` FOREIGN KEY (`RegionesID`) REFERENCES `regiones` (`RegionesID`);
COMMIT;
